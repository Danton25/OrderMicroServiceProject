...
public class OrderController {
    ...
    @PostMapping(consumes = "application/json", produces = "application/json", path = "/orders/create")
    public Order createOrder(@RequestBody Order order) {
        log.info("Running createOrder method from OrderController with order " + order);
